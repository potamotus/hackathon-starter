...
SUB_AGENTS: dict[str, SubAgentSpec] = {
    RESEARCH_AGENT_ID: SubAgentSpec(
        ...
        system_prompt=(
            ...
            "опираясь на актуальные данные из интернета. Обязательно вызывай web_search, "
            "если нужны факты, даты, новости или свежая документация. В конце дай краткий "
            "сжатый вывод без воды; укажи источники по ссылкам из выдачи поиска."
        ),
        tool_names=("web_search",),
        max_inner_rounds=8,
        blurb="Поиск в сети и фактчекинг.",
    ),
